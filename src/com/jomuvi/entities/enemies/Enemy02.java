...
public class Enemy02 extends Entity {
	...
	private int life = 150, maxLife = 150, xpEnemy = 50, idEnemy = 2, Damaged = 5;
	...
	public void tick() {
		if ((calculeteDistance(this.getX(), Game.player.getX(), this.getY(), Game.player.getY()) < 60 || life < maxLife)) {
			if (!this.isColiddingWithPlayer()) {
				if ((int) x < Game.player.getX() && World.isfree((int) (x + speed), this.getY())
						&& !isColiddingEnemies2((int) (x + speed), this.getY())) {
					moved = true;
					dir = right_dir;
					x += speed;
				...
				if ((int) y < Game.player.getY() && World.isfree(this.getX(), (int) (y + speed))
						&& !isColiddingEnemies2(this.getX(), (int) (y + speed))) {
					moved = true;
					y += speed;
...
//				Sound.hurtEffect.play();
	...
	public void render(Graphics g) {
		...
		if (ShowLife) {
			...
			g.drawString("Zombie level 2 ", (Game.WIDTH / 2) - 38, 12);
	...
	public int getMaxFramesShowLife() {
		return maxFramesShowLife;
	}

	public void setMaxFramesShowLife(int maxFramesShowLife) {
		this.maxFramesShowLife = maxFramesShowLife;
	}

	public int getFramesShowLife() {
		return framesShowLife;
	}

	public void setFramesShowLife(int framesShowLife) {
		this.framesShowLife = framesShowLife;
	}
}
